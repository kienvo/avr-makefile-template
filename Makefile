...
SYMBOL = -DF_CPU=16000000UL -DBAUD=230400UL -DDEBUG -DTW_DEBUG
########################################
...
WARNING = -Wall -Wextra -Werror=conversion -Werror=format -Wfatal-errors
...
flash: all
	 avrdude.exe -cusbasp -p$(DEV) -U flash:w:$(APP).hex:i -v
